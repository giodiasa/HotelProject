    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 4, 19, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5228), new DateTime(2024, 4, 29, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5237) },
                    { 2, new DateTime(2024, 4, 19, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5244), new DateTime(2024, 5, 19, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5245) },
                    { 3, new DateTime(2024, 4, 19, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5270), new DateTime(2024, 5, 9, 4, 12, 15, 471, DateTimeKind.Local).AddTicks(5270) }
                });
